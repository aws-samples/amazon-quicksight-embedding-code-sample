...
def generate_console_embed_url(aws_account_id, get_user_arn_response, dashboard_id, sheet_id, visual_id):
    try:
...
def handler(event, context):
    ...
    try:
            ...
            get_embed_url_response = generate_console_embed_url(aws_account_id, get_user_arn_response, dashboard_id, sheet_id, visual_id)
